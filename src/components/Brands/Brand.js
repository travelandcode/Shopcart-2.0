function Brand(props){
    ...
    return(
        <div className="[ brand ][ bg-[#f5f6f6] ][ w-[302px] h-[112px] phone:w-[160px] phone:h-auto tablet:w-auto ][ p-[20px] phone:p-[10px] ][ border border-solid border-[#f5f6f6] ][ rounded-[10px] ][ flex flex-row phone:flex-col ][ hover:border-[#003d29] ]">
            <img src={img} className="[ brand-img ][ mr-[18px] ][ phone:w-[60px] phone:h-[60px] ][ transition-transform hover:scale-[1.2] ][ phone:mb-[5px] ]"/>

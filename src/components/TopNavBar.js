function TopNavBar () {
    return (
        <div className="[ topnav ][ bg-[#003d29] h-[36px] ][ py-[7px] ][ flex flex-row ][ phone:hidden ][ tablet:w-screen ]" >
            <div className=" [ topnav-container ][ flex flex-row ][ mx-auto px-[40px] tablet:px-[20px] ][ w-[1360px] tablet:w-[740px] ][ justify-between ]">

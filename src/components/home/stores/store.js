...
function Store(props){
    ...
    return (
        <div className="[ store ][ border-solid border border-[#E0E0E0] shadow-xl ][ h-[375px] w-[302px] phone:w-[160px] phone:h-[220px] ][ mx-auto ][ relative ][ z-0 ][ rounded-[10px] ][ flex flex-col ]">
            <div className="[ store-img-container ][ rounded-[10px] ][ overflow-hidden ]">
                <img className="[ store-img ][ w-full h-[240px] phone:h-[127.6px] ][ transition-transform hover:scale-[1.2] ][ rouned-[10px] ]" src={img} alt="store"/>
            </div>
            <div className="[ store-content ][ relative ][ z-[99] ][ mt-[-29px] ][ px-[20px] phone:px-[10px] ]">
                <img className="[ brand-img ][ mb-[10px] phone:mb-[5px] ][ w-[62px] h-[62px] phone:w-[50px] phone:h-[50px] ]" src={brandImg} alt="brand"/>
                ...
                <div className="[ delivery-container ][ flex flex-row ][ items-center ]">
                    <img className="[ delivery-img ][ w-[13px] h-[13px] phone:w-[11px] phone:h-[11px] ]" src="https://uploads-ssl.webflow.com/63e857eaeaf853471d5335ff/63ea2eeefd8efb290e2d7d78_Icon.png"  alt="price-tag"/>

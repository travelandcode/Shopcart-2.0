...
function LoginModal(props){
  ...
  const loginButtons = [
    {
      link: 'https://theshopcart-api.vercel.app/phone',
    ...
    {
      link: 'https://theshopcart-api.vercel.app/auth/facebook',
    ...
    {
      link: 'https://theshopcart-api.vercel.app/auth/google',
      svgData: (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none">
    ...
    {
      link: 'https://theshopcart-api.vercel.app/auth/twitter',
      svgData: (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none">
    ...
    {
      link: 'https://theshopcart-api.vercel.app/auth/microsoft',

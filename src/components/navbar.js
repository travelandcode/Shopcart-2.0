        ...
        <div className="[ navbar ][ py-[15px] ][ sticky top-0 ][ z-[2] ][ bg-[#fff] ][ w-full h-[82px] tablet:w-[760px] ][ px-[40px] tablet:px-[20px] ][ flex flex-row ][ border-b border-[#cccccc] ][ mx-auto ][ phone:hidden ]">
            <div className="[ nav-bar-container ][ flex flex-row [ mx-auto ][ w-full tablet:w-full ][ justify-between ] ">
                ...
                <div className="[ nav-container ][ flex flex-row ][ w-auto h-[52px] tablet:w-auto ]">
                    ...
                    <div className="[ search-bar-container ][ w-auto tablet:w-auto ][ my-auto ]">
                        <div className="[ search-bar ][ w-[550px] h-[40px] ][ rounded-[100px] ][ mx-auto my-auto ][ flex ][ relative ]">
                            <input onChange={(e) => setSearchTerm(e.target.value)} className="[ search-input ][ h-full w-full ][ bg-[#f1f1f2] ][ my-auto ][ rounded-[100px] ][ pl-[20px] pr-[50px] ][ focus:outline-[#3898EC] focus:outline ]" placeholder="Search Shopcart"/>
                            <button onClick={handleSearch} className="[ search-icon-container ][ w-[60px] h-[40px] ][ absolute top-0 right-0 ][ flex ]">
